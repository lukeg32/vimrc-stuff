...
"syn region celDescBlock start="{" end="}" fold transparent contains=celBlockCmd, celNumber, celTodo, celDesc, celComment

syn keyword celBlockCmd RA Dec Distance AbsMag Mass nextgroup=celNumber contained celDescBlock
syn keyword celBlockCmd SpectralType nextgroup=celDesc contained celDescBlock
